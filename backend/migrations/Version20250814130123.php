 ...
 */
final class Version20250814130123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE directory (id VARCHAR(32) NOT NULL, parent_id VARCHAR(32) DEFAULT NULL, owner_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_467844DA727ACA70 (parent_id), INDEX IDX_467844DA7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE file (id VARCHAR(32) NOT NULL, directory_id VARCHAR(32) DEFAULT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(15) NOT NULL, size INT NOT NULL, UNIQUE INDEX UNIQ_8C9F36105E237E06 (name), INDEX IDX_8C9F36102C94069F (directory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
